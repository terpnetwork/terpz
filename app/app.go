...
func NewTerpApp(
	...
	app.mm = module.NewManager(genutil.NewAppModule(
		...
		leanval.WrapDistribution(distr.NewAppModule(appCodec, *app.DistrKeeper, app.AccountKeeper, app.BankKeeper, app.StakingKeeper, app.GetSubspace(distrtypes.ModuleName)), app.LeanvalKeeper),
